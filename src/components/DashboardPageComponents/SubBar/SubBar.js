      ...
      <div className="w-full lg:flex lg:items-center lg:justify-between lg:px-24">
        <div className="flex items-center">
          <div className="flex item-center">
            <div>
              <p className="small text-gray-800 text-md mt-6 mr-13 pl-4 " id="directory">
                Directory :
              </p>
            </div>
            <div className="text-gray-800 text-md font-semibold mt-5 mr-14">
              <BreadCrumb />
            </div>
          </div>
        </div>
        ...
        <div className="ml-4 lg:ml-0">
          <ul className="flex items-center space-x-3 mx-auto" id="modal-folders">
